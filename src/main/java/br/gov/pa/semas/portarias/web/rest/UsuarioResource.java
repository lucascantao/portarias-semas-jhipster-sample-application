...
import br.gov.pa.semas.portarias.repository.UsuarioRepository;
...
/**
 * REST controller for managing {@link br.gov.pa.semas.portarias.domain.Usuario}.
 */
@RestController
        ...
        Optional<Usuario> result = usuarioRepository
            ...
            .map(existingUsuario -> {
                ...
                if (usuario.getCreatedAt() != null) {
                    existingUsuario.setCreatedAt(usuario.getCreatedAt());
                }
                if (usuario.getUpdatedAt() != null) {
                    existingUsuario.setUpdatedAt(usuario.getUpdatedAt());
                }
                if (usuario.getDeletedAt() != null) {
                    existingUsuario.setDeletedAt(usuario.getDeletedAt());
                }
