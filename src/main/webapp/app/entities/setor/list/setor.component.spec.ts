...
import { sampleWithRequiredData } from '../setor.test-samples';
...
describe('Setor Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, SetorComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to setorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSetorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSetorIdentifier).toHaveBeenCalledWith(entity);
