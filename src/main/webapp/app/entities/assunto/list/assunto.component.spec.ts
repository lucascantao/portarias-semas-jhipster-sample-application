...
import { sampleWithRequiredData } from '../assunto.test-samples';
...
describe('Assunto Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, AssuntoComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to assuntoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getAssuntoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getAssuntoIdentifier).toHaveBeenCalledWith(entity);
