...
import { sampleWithRequiredData } from '../topico.test-samples';
...
describe('Topico Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, TopicoComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.topicos?.[0]).toEqual(expect.objectContaining({ id: '9fec3727-3421-4967-b213-ba36557ca194' }));
  });

  describe('trackId', () => {
    it('Should forward to topicoService', () => {
      const entity = { id: '9fec3727-3421-4967-b213-ba36557ca194' };
      jest.spyOn(service, 'getTopicoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTopicoIdentifier).toHaveBeenCalledWith(entity);
